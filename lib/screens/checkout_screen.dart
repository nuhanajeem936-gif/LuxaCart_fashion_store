                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          _buildFormInput("Full Name", Icons.person_outline, _nameController, "Full name"),
                          const SizedBox(height: 12),
                          _buildFormInput("Phone Number", Icons.phone_outlined, _phoneController, "Phone number", TextInputType.phone),
                          const SizedBox(height: 12),
                          _buildFormInput("Shipping Address", Icons.location_on_outlined, _addressController, "Address"),
                          const SizedBox(height: 12),
                          Row(
                            children: [
                              Expanded(
                                child: _buildFormInput("City", Icons.location_city_outlined, _cityController, "City"),
                              ),
                              const SizedBox(width: 10),
                              Expanded(
                                child: _buildFormInput("Zip Code", Icons.pin_drop_outlined, _zipController, "Zip code", TextInputType.number),
                              ),
                            ],
                          ),
                        ],
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text("\$${shipping.toStringAsFixed(2)}", style: const TextStyle(fontWeight: FontWeight.w600)),
                            ],
                          ),
                  ...
                  onPressed: orderVM.isPlacingOrder
                      ...
                      : () async {
                          if (_formKey.currentState!.validate()) {
                            ...
                            final orderedItems = List<ProductModel>.from(cartVM.cartItems);
