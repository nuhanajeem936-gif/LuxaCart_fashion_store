    ...
    /// ================= WOMEN =================
      ...
      products = [
        ProductModel(
          ...
          details:
              "White long-sleeve mini dress with classy feminine styling for elegant casual outings.",
          price: 3200,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "Soft pink floral maxi dress with flowy silhouette and romantic summer vibes.",
          price: 3500,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "White floral printed ethnic-style dress with modern casual elegance.",
          price: 2800,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "Stylish checked blazer and skirt set paired with long boots for premium fashion styling.",
          price: 6000,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "Dark red knit sweater styled with cream trousers for cozy everyday fashion.",
          price: 2500,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "Black floral midi dress with relaxed fit and elegant street-style appearance.",
          price: 3000,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "Neutral crop top with cream jogger pants for trendy urban styling.",
          price: 4200,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "Denim jacket layered over floral maxi dress for youthful casual fashion.",
          price: 4500,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "Puff sleeve cream dress with soft premium aesthetic and graceful styling.",
          price: 7000,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "Elegant brown sleeveless midi dress designed for modern minimalist fashion lovers.",
          price: 3300,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "Loose-fit floral printed ethnic kaftan dress with soft airy comfort.",
          price: 2700,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "White ethnic outfit paired with navy embroidered cape for festive elegance.",
          price: 8500,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "Deep red long gown with sophisticated evening party styling.",
          price: 9000,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "Brown fitted top with floral flowing skirt for classy outdoor fashion.",
          price: 3800,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "Light green traditional-style long dress with elegant embroidery details.",
          price: 2900,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "White and aqua floral ethnic saree set designed for festive occasions.",
          price: 7500,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "Cream embroidered kurti with matching pants for modern ethnic wear.",
          price: 3100,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "Maroon embroidered kurti paired with white bottoms for traditional elegance.",
          price: 2600,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "Soft pink designer saree with glamorous festive styling and elegant drape.",
          price: 6800,
          category: "Women",
        ),
        ProductModel(
          ...
          details:
              "Elegant pastel blue saree with premium partywear aesthetic and graceful finish.",
          price: 9500,
          category: "Women",
        ),
      ];
    ...
    /// ================= UNISEX =================
      ...
      products = [
        ProductModel(
          ...
          details:
              "Matching beige couple hoodies with stylish puzzle-heart design crafted for cozy comfort, romantic fashion, and trendy streetwear looks.",
          price: 3500,
          category: "Unisex",
        ),
        ProductModel(
          ...
          image: "assets/images/ux1.jpg",
          details:
              "Modern pastel pink matching outfit designed for stylish couples who love elegant casual fashion and coordinated streetwear vibes.",
          price: 6200,
          category: "Unisex",
        ),
        ProductModel(
          ...
          details:
              "Relaxed oversized matching hoodie and shorts set made for comfortable travel wear and trendy casual styling.",
          price: 5800,
          category: "Unisex",
        ),
        ProductModel(
          ...
          details:
              "Minimalist white t-shirt and loose pants combo designed for modern unisex fashion and effortless daily comfort.",
          price: 5400,
          category: "Unisex",
        ),
        ProductModel(
          ...
          details:
              "Premium beige oversized coordinated outfit with luxury street-style aesthetics and ultra-comfortable fabric.",
          price: 7600,
          category: "Unisex",
        ),
        ProductModel(
          ...
          details:
              "Neutral-toned matching sweatshirt and jeans set designed for casual outings, travel, and cozy daily fashion.",
          price: 5200,
          category: "Unisex",
        ),
        ProductModel(
          ...
          details:
              "Stylish striped t-shirt set paired with black bottoms for modern casual fashion and coordinated everyday styling.",
          price: 4300,
          category: "Unisex",
        ),
        ProductModel(
          ...
          details:
              "Trendy color-block t-shirt outfit with modern streetwear vibes and lightweight comfort for casual fashion lovers.",
          price: 4700,
          category: "Unisex",
        ),
        ProductModel(
          ...
          details:
              "Soft pastel striped sweater with romantic typography design crafted for cozy winter fashion and aesthetic couple styling.",
          price: 5900,
          category: "Unisex",
        ),
        ProductModel(
          ...
          details:
              "Korean-inspired oversized purple hoodie set designed for trendy street fashion, comfort, and fan-inspired aesthetics.",
          price: 6500,
          category: "Unisex",
        ),
        ProductModel(
          ...
          details:
              "Stylish dark purple matching hoodies with modern oversized fit designed for cozy winter nights and streetwear fashion.",
          price: 6100,
          category: "Unisex",
        ),
        ProductModel(
          ...
          details:
              "Elegant matching formal blazer set designed for luxury fashion styling, events, and modern power-couple aesthetics.",
          price: 8500,
          category: "Unisex",
        ),
        ProductModel(
          ...
          details:
              "Soft oversized matching sweatshirts featuring romantic back-print typography for cute couple fashion and cozy comfort.",
          price: 5700,
          category: "",
        ),
        ProductModel(
          ...
          details:
              "Premium cream-colored oversized hoodies crafted for minimalist fashion lovers seeking comfort and modern streetwear elegance.",
          price: 6000,
          category: "Unisex",
        ),
        ProductModel(
          ...
          details:
              "Stylish black coordinated outfit with edgy streetwear aesthetics and premium comfort for modern unisex fashion.",
          price: 6800,
          category: "Unisex",
        ),
        ProductModel(
          ...
          details:
              "Matching dark grey heart-print t-shirts and shorts designed for minimalist couple fashion and relaxed everyday comfort.",
          price: 5200,
          category: "Unisex",
        ),
      ];
    ...
    /// ================= KIDS =================
      ...
      products = [
        ProductModel(
          ...
          details:
              "Elegant layered pink party dress with soft tulle fabric and princess-inspired styling for birthdays, weddings, and special occasions.",
          price: 8500,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Stylish boys’ casual summer outfit with a soft blue shirt and matching shorts designed for comfort and trendy outdoor fashion.",
          price: 5200,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Bright striped shirt with white shorts crafted for playful summer fashion and comfortable daily wear for kids.",
          price: 4800,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Cute pastel top and embroidered skirt combo featuring a charming ribbon design perfect for casual and party styling.",
          price: 4200,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Soft knitted bunny-themed sweater with matching skirt designed for cozy winter comfort and adorable fashion styling.",
          price: 5000,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Elegant pink sweater paired with a soft white skirt for classy and comfortable winter fashion for little girls.",
          price: 4700,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Colorful tropical shirt and shorts outfit designed for beach vacations, summer adventures, and stylish comfort.",
          price: 5500,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Elegant boys’ formal suit with vest and bowtie crafted for weddings, birthdays, and premium party styling.",
          price: 6800,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Soft denim romper with adorable teddy embroidery designed for cozy baby comfort and playful daily wear.",
          price: 3900,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Cute denim dress with floral details and soft inner fabric for stylish and comfortable casual wear.",
          price: 4500,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Elegant sleeveless blue dress featuring a graceful flowy silhouette perfect for parties and special occasions.",
          price: 6200,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Trendy animal-print shirt with bright orange shorts designed for playful summer adventures and casual comfort.",
          price: 4300,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Soft pink sweatshirt paired with a stylish white skirt for adorable and comfortable everyday fashion.",
          price: 4600,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Stylish black hoodie outfit with modern streetwear vibes designed for warmth, comfort, and trendy fashion.",
          price: 5700,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Beautiful floral printed frock crafted with lightweight breathable fabric for elegant party and summer styling.",
          price: 6500,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Comfortable striped t-shirt with matching shorts designed for cool casual summer fashion and daily wear.",
          price: 4900,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Trendy black t-shirt and shorts outfit with modern street-style fashion for stylish everyday comfort.",
          price: 5200,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Cute suspender shorts with soft shirt and matching cap designed for charming outdoor and casual styling.",
          price: 4900,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Elegant yellow checkered dress with soft puff sleeves crafted for premium comfort and adorable fashion looks.",
          price: 5800,
          category: "Kids",
        ),
        ProductModel(
          ...
          details:
              "Soft peach-colored baby frock with elegant layered styling designed for birthdays, parties, and special occasions.",
          price: 4400,
          category: "Kids",
        ),
      ];
    ...
    /// ================= BAGS =================
      ...
      products = [
        ProductModel(
          ...
          details:
              "Spacious pastel pink backpack with bunny ears and soft plush keychain, perfect for school and daily use.",
          price: 3000,
          category: "Bags",
        ),
        ProductModel(
          ...
          details:
              "Stylish maroon leather handbag with gold chain details, designed for modern casual and formal fashion.",
          price: 6000,
          category: "Bags",
        ),
        ProductModel(
          ...
          details:
              "Premium white tote handbag with decorative accessories, suitable for office, shopping, and travel.",
          price: 4000,
          category: "Bags",
        ),
        ProductModel(
          ...
          details:
              "Trendy mint green handbag collection with matching mini pouch and accessories for a fashionable look.",
          price: 5000,
          category: "Bags",
        ),
        ProductModel(
          ...
          details:
              "Elegant cream shoulder bag with gold chain strap and floral detailing, ideal for parties and events.",
          price: 4000,
          category: "Bags",
        ),
        ProductModel(
          ...
          details:
              "Soft knitted cream tote bag with a large bow design, combining comfort and style for everyday use.",
          price: 2700,
          category: "Bags",
        ),
        ProductModel(
          ...
          details:
              "Beautiful pink woven handbag decorated with pearls and charms, perfect for feminine fashion styles.",
          price: 3000,
          category: "Bags",
        ),
        ProductModel(
          ...
          details:
              "Durable grey laptop handbag with padded protection, designed for office work and business travel.",
          price: 4500,
          category: "Bags",
        ),
        ProductModel(
          ...
          details:
              "Compact dark red shoulder bag with a glossy finish, ideal for evening outings and casual wear.",
          price: 7000,
          category: "Bags",
        ),
        ProductModel(
          ...
          details:
              "Elegant quilted cream sling bag with gold chain strap, offering a stylish and modern appearance.",
          price: 5500,
          category: "Bags",
        ),
      ];
    ...
    /// ================= COSMETICS =================
      ...
      products = [
        ProductModel(
          ...
          details:
              "Collection of rich matte lipsticks with smooth texture and long-lasting color for daily and party makeup.",
          price: 2000,
          category: "Cosmetics",
        ),
        ProductModel(
          ...
          details:
              "Elegant fragrance perfume with a bold and sophisticated scent, suitable for special occasions.",
          price: 8500,
          category: "Cosmetics",
        ),
        ProductModel(
          ...
          details:
              "Lightweight compact face powder that provides smooth coverage and a natural radiant finish.",
          price: 3000,
          category: "Cosmetics",
        ),
        ProductModel(
          ...
          details:
              "Refreshing men’s perfume with a cool and modern fragrance for everyday confidence.",
          price: 7000,
          category: "Cosmetics",
        ),
        ProductModel(
          ...
          details:
              "Soft nude-toned eyeshadow palette featuring multiple shades for natural and glamorous eye makeup looks.",
          price: 6000,
          category: "Cosmetics",
        ),
        ProductModel(
          ...
          details:
              "Complete skincare collection with creams and lotions designed to nourish and hydrate the skin.",
          price: 9000,
          category: "Cosmetics",
        ),
        ProductModel(
          ...
          details:
              "Stylish makeup gift box including lipsticks and beauty essentials for a trendy makeup experience.",
          price: 8000,
          category: "Cosmetics",
        ),
        ProductModel(
          ...
          details:
              "Sweet-themed skincare and beauty set with gentle products for daily self-care routines.",
          price: 10000,
          category: "Cosmetics",
        ),
        ProductModel(
          ...
          details:
              "Waterproof liquid eyeliner designed for sharp, bold, and long-lasting eye definition.",
          price: 1500,
          category: "Cosmetics",
        ),
        ProductModel(
          ...
          details:
              "Vibrant lip tint set with shiny finish and moisturizing formula for soft colorful lips.",
          price: 2600,
          category: "Cosmetics",
        ),
      ];
    ...
    /// ================= ACCESSORIES =================
      ...
      products = [
        ProductModel(
          ...
          details:
              "Soft satin ribbon hair bow clips designed for elegant hairstyles, casual fashion, and party wear. Lightweight, stylish, and perfect for everyday feminine looks.",
          price: 1500,
          category: "Accessories",
        ),
        ProductModel(
          ...
          details:
              "Premium black round-frame sunglasses with UV protection and minimalist luxury styling. Perfect for street fashion and daily wear.",
          price: 3200,
          category: "Accessories",
        ),
        ProductModel(
          ...
          details:
              "Delicate gold necklace featuring elegant pearl accents for classy modern styling. Ideal for casual outfits, parties, and formal occasions.",
          price: 2800,
          category: "Accessories",
        ),
        ProductModel(
          ...
          details:
              "Luxury black wristwatch with matching bracelet accessories crafted for sophisticated and modern fashion lovers. Premium metallic finish with elegant detailing.",
          price: 4500,
          category: "Accessories",
        ),
        ProductModel(
          ...
          details:
              "Elegant multi-layer ring set featuring minimalist crystal and metallic designs for trendy modern fashion. Perfect for casual wear, parties, and aesthetic styling.",
          price: 4000,
          category: "Accessories",
        ),
        ProductModel(
          ...
          details:
              "Neutral-toned aesthetic hair claw and clip set made for elegant hairstyles and daily fashion styling. Durable, lightweight, and comfortable to wear.",
          price: 3000,
          category: "Accessories",
        ),
        ProductModel(
          ...
          details:
              "Premium luxury wristwatch featuring gold and silver metallic detailing with a modern sophisticated appearance for formal and casual styling.",
          price: 12000,
          category: "Accessories",
        ),
        ProductModel(
          ...
          details:
              "Stylish layered black bracelet collection with modern masculine aesthetics and premium comfort fit. Perfect for casual and streetwear fashion.",
          price: 5000,
          category: "Accessories",
        ),
        ProductModel(
          ...
          details:
              "Elegant matching couple ring set with premium metallic finish and minimalist romantic design. Perfect for anniversaries, gifts, and everyday couple fashion styling.",
          price: 1200,
          category: "Accessories",
        ),
        ProductModel(
          ...
          details:
              "Elegant rose gold wristwatch with sparkling crystal details and premium bracelet design for luxury feminine fashion and formal styling.",
          price: 2500,
          category: "Accessories",
        ),
      ];
    ...
    /// ================= FOOTWEAR =================
      ...
      products = [
        ProductModel(
          ...
          details:
              "Stylish grey and pink sporty sneakers designed for comfort, daily wear, and lightweight running performance..",
          price: 5500,
          category: "Footwear",
        ),
        ProductModel(
          ...
          details:
              "Elegant cream bow heels with a soft feminine look, perfect for parties, weddings, and classy casual outfits.",
          price: 5000,
          category: "Footwear",
        ),
        ProductModel(
          ...
          details:
              "Luxury white glitter flats with premium finishing and cushioned comfort for elegant everyday fashion.",
          price: 6500,
          category: "Footwear",
        ),
        ProductModel(
          ...
          details:
              "Modern black slip-on slides with soft ergonomic sole, ideal for casual indoor and outdoor wear.",
          price: 4800,
          category: "Footwear",
        ),
        ProductModel(
          ...
          details:
              "Trendy silver textured slippers with anti-slip comfort and sporty modern styling.",
          price: 3200,
          category: "Footwear",
        ),
        ProductModel(
          ...
          details:
              "Premium black velvet loafers with golden buckle detail, crafted for luxury formal fashion.",
          price: 8000,
          category: "Footwear",
        ),
        ProductModel(
          ...
          details:
              "Cute white baby shoes with bow design, made for soft comfort and adorable kids fashion.",
          price: 4200,
          category: "Footwear",
        ),
        ProductModel(
          ...
          details:
              "Ultra-soft pink bunny slippers designed for warmth, relaxation, and cozy indoor comfort.",
          price: 2500,
          category: "Footwear",
        ),
        ProductModel(
          ...
          details:
              "Sophisticated black ankle heels with gold buckle accents for bold and classy fashion looks.",
          price: 5200,
          category: "Footwear",
        ),
        ProductModel(
          ...
          details:
              "Lightweight black running sneakers with breathable mesh and cushioned sole for all-day comfort.",
          price: 6000,
          category: "Footwear",
        ),
      ];
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "Luxury looks, fresh arrivals, and everyday essentials.",
                    maxLines: 2,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
